...
export const popupImagePicture = document.querySelector(".popup__form_picture_image");
export const popupNamePicture = document.querySelector(".popup__form_picture_name");
