...
export const popupImagePicture = document.querySelector(".popup__form_picture-image");
export const popupNamePicture = document.querySelector(".popup__form_picture-name");
